...
class ChangeDetector:
    ...
    compute_dod_streaming_files_tiled = staticmethod(
        DoDDetector.compute_dod_streaming_files_tiled
    )
    compute_dod_streaming_files_tiled_parallel = staticmethod(
        DoDDetector.compute_dod_streaming_files_tiled_parallel
    )
    ...
    compute_c2c_streaming_files_tiled = staticmethod(
        C2CDetector.compute_c2c_streaming_files_tiled
    )
    compute_c2c_streaming_files_tiled_parallel = staticmethod(
        C2CDetector.compute_c2c_streaming_files_tiled_parallel
    )

    # M3C2 methods
    autotune_m3c2_params = staticmethod(M3C2Detector.autotune_m3c2_params)
    autotune_m3c2_params_from_headers = staticmethod(
        M3C2Detector.autotune_m3c2_params_from_headers
    )
    compute_m3c2_original = staticmethod(M3C2Detector.compute_m3c2_original)
    compute_m3c2_streaming_files_tiled = staticmethod(
        M3C2Detector.compute_m3c2_streaming_files_tiled
    )
    compute_m3c2_streaming_files_tiled_parallel = staticmethod(
        M3C2Detector.compute_m3c2_streaming_files_tiled_parallel
    )
    compute_m3c2_streaming_pertile_parallel = staticmethod(
        M3C2Detector.compute_m3c2_streaming_pertile_parallel
    )
