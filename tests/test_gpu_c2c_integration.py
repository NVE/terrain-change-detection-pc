...
class TestBasicC2CGPU:
    ...
    def test_gpu_cpu_parity_basic_c2c(
        self, sample_clouds, gpu_config, cpu_config, gpu_available
    ):
        ...
        np.testing.assert_allclose(
            gpu_result.distances, cpu_result.distances, rtol=1e-5
        )
...
class TestVerticalPlaneC2CGPU:
    ...
    def test_gpu_cpu_parity_vertical_plane(
        self, sample_clouds, gpu_config, cpu_config, gpu_available
    ):
        ...
        assert np.sum(valid_cpu) == np.sum(valid_gpu), (
            "Different number of valid results"
        )
    ...
    def test_gpu_vertical_plane_with_radius(
        self, sample_clouds, gpu_config, gpu_available
    ):
...
class TestPerformance:
    ...
    def test_gpu_speedup_basic_c2c(
        self, large_sample_clouds, gpu_config, cpu_config, gpu_available
    ):
        ...
        np.testing.assert_allclose(
            gpu_result.distances, cpu_result.distances, rtol=1e-4
        )
